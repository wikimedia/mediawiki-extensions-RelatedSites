...
$wgExtensionCredits['parserhook']['RelatedSites'] = array( 'name' => 'RelatedSites', 'url' => 
'http://wikivoyage.org/tech/RelatedSites-Extension', 'author' => 'Roland Unger/Hans Musil',
...
class RelatedSites
{
  ...
  function onParserBeforeTidy( &$parser, &$text)
  {
    global $wgCustomData, $wgRelatedSitesPrefixes;
		...
		if( !$wgRelatedSitesPrefixes){ return true;};
...
<?php
			...
			{ ?>
				...
				?>" <?php if($rslink['text'] == 'Wikitravel'){echo 'rel="nofollow"';};
